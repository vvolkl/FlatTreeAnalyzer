...
variables = {
    ...
    "mzp":{"name":"zprime_muon_m","title":"m_{Z'} [TeV]","bin":200,"xmin":0,"xmax":16, "divide":1000},
    "ptmu_1":{"name":"lep1_pt","title":"p_{T}^{#mu, max} [TeV]","bin":100,"xmin":0,"xmax":16, "divide":1000},
    "ptmu_2":{"name":"lep2_pt","title":"p_{T}^{#mu, min} [TeV]","bin":100,"xmin":0,"xmax":16, "divide":1000},
}
