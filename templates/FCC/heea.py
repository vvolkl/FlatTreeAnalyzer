...
variables = {
    ...
    "pte1":{"name":"l1_pt","title":"p_{T}^{max}(e) [GeV]","bin":100,"xmin":0,"xmax":1000},
    "pte2":{"name":"l2_pt","title":"p_{T}^{min}(e) [GeV]","bin":100,"xmin":0,"xmax":1000},
...
selbase_nomasscut += ' && abs(l1_pdgid)==11  && abs(l2_pdgid)==11'
...
selbase_masscut += ' && abs(l1_pdgid)==11  && abs(l2_pdgid)==11'
