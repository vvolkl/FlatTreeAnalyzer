...
variables = {
    ...
    "njets":{"name":"njets","title":"njets","bin":24,"xmin":0,"xmax":12},
    "nbjets":{"name":"nbjets","title":"nbjets","bin":24,"xmin":0,"xmax":12},
    "nextraleptons":{"name":"nextraleptons","title":"nextraleptons","bin":8,"xmin":0,"xmax":8},
    "higgs_m":{"name":"higgs_m","title":"m_{H} [GeV]","bin":200,"xmin":50,"xmax":200},
...
signal_groups['ttH'] = ['mgp8_pp_tth01j_5f_hllll']

background_groups = collections.OrderedDict()
background_groups['background'] = [
                                  'mgp8_pp_ttv01j_5f',
                                  ]
