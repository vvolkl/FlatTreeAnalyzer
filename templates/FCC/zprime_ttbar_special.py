...
background_groups['m_{Z} = 15 TeV']  = ['pp_Zprime_15TeV_ttbar']
background_groups['m_{Z} = 20 TeV']  = ['pp_Zprime_20TeV_ttbar']
background_groups['m_{Z} = 25 TeV']  = ['pp_Zprime_25TeV_ttbar']
background_groups['m_{Z} = 30 TeV']  = ['pp_Zprime_30TeV_ttbar']
